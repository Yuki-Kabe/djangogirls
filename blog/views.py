...
def post_list(request):
    ...
    return render(request, template_name='blog/post_list.html', context={'posts': published_posts})
...
def post_draft_list(request):
    ...
    return render(request, template_name='blog/post_draft_list.html', context={'posts': drafts})
...
def add_comment_to_post(request, pk):
    ...
    if request.method == "POST":
        ...
        form = CommentForm()
    return render(request, template_name='blog/add_comment_to_post.html', context={'form': form})
